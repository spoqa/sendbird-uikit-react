...
var uuid = require('./bundle-g72Ialyc.js');
...
var VoiceRecorderProvider = function (props) {
    ...
    React.useEffect(function () {
        if (isVoiceMessageEnabled && !webAudioUtils) {
            Promise.resolve().then(function () { return require('./bundle-BytSBslC.js'); }).then(function (module) { return setWebAudioUtils(module); });
        }
...
//# sourceMappingURL=bundle-mOf92gcC.js.map
